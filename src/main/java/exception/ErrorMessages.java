...
public class ErrorMessages {
    ...
    public static class CurrencyError {
        ...
        public static final String CURRENCY_NOT_FOUND_MESSAGE_TEMPLATE =
                "Одна или обе валюты из валютной пары  не найдены :";
    }
    ...
    public static class ParameterError {
        ...
        public static final String ERROR_NO_CURRENCY_SELECTED = "Не выбрана валюта для создания обменного курса";
    ...
    public static class ExchangeRatesError {
        ...
        public static final String EXCHANGE_PAIR_CODE_MISSING = "Код обменной пары отсутствует в запросе";
    }
}
